...
import org.acme.service.MyRemoteBoletoService;
import org.acme.service.TokenBoletoService;
...
public class GreetingResourceController {
    ...
    @Inject
    @RestClient
    MyRemoteBoletoService restClient;

    @Inject
    @RestClient
    TokenBoletoService tokenBoletoService;
    ...
    public Response hello() {
        ...
        TokenBoleto entity = new TokenBoleto();
    ...
    public TokenBoletoDTO getToken() {
        ...
        TokenBoletoDTO token = tokenBoletoService.getToken(form);
    ...
    public Response payment(ConsultBoletoDto dto) {
        ...
        PaymentBoleto entity = new PaymentBoleto();
